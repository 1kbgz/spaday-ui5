...
const PACKAGES = ["@ui5/webcomponents"];
const OUT = "../spaday_ui5/custom-elements.json";
...
const UNPUBLISHED = fs.existsSync("tools/unpublished.json")
  ...
  : {};
// the platform and UI5's framework base contribute nothing an author sets
const PLATFORM = new Set(["HTMLElement", "UI5Element"]);
